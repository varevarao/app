...
export default {
  about_directus: "À propos de Directus",
  activity: "Activité",
  ...
  collection_names_cannot_be_changed:
    "Les noms des collection ne peuvent pas être modifiés pour le moment",
  ...
  create: "Créer",
  creating_item: "Création d’élément",
  creating_item_page_title: "Création d’élément : {collection}",
  creating_role: "Création de rôle",
  ...
  fieldtypes: {
    ...
    group:
      "Regroupement visuel de champs, les champs enfants enregistrent le groupe dans directus_fields.group",
    ...
    translation:
      "Spécifique aux interfaces de traduction, cette relation One-to-Many stocke du contenu multilingue",
  ...
  datatypes: {
    mysql: {
      ...
      SMALLINT:
        "Un nombre entier compris dans l’intervalle [-32 768,32 767] s’il est signé. Sinon, compris dans l’intervalle [0,65 535].",
      MEDIUMINT:
        "Un nombre entier compris dans l’intervalle [-8 388 608,8 388 607] s’il est signé. Sinon, compris dans l’intervalle [0,16 777 215].",
      INT:
        "Un nombre entier compris dans l’intervalle [-2 147 483 648,2 147 483 647] s’il est signé. Sinon, compris dans l’intervalle [0,4 294 967 295].",
      BIGINT:
        "Un nombre entier compris dans l’intervalle [-9 223 372 036 854 775 708,9 223 372 036 854 775 807] s’il est signé. Sinon, compris dans l’intervalle [0,18 446 744 073 709 551 615].",
      DECIMAL:
  ...
  delete_bookmark_body:
    "Êtes vous sûr de vouloir supprimer ce favori ? Cette action ne peut pas être annulée !",
  ...
  esc_cancel: "Échap va annuler et fermer la fenêtre.",
  equal_to: "Égal à",
  existing: "Existant",
  ...
  file_upload: "Téléverser un(des) fichier(s)",
  ...
  initial_schema_copy:
    "Choisissez parmi les architectures de base de données existantes ou démarrez à zéro. Vous pourrez toujours étendre et modifier cela plus tard.",
  interface: "Interface",
  ...
  install: "Installer",
  install_copy:
    "Cette API n’a pas encore été configurée. Voulez-vous l’installer et la configurer maintenant ?",
  is_empty: "Est vide",
  ...
  name_bookmark: "Comment voudriez-vous nommer ce favori ?",
  next: "Suivant",
  none: "Aucun",
  ...
  relation_setup_copy:
    "Il existe différents types de données relationnelles, cette interface en utilise une appelée « {relation} ».",
